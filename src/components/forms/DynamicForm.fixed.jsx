...
// First define the component and properly handle the props
const DynamicFormComponent = ({ sectionId, currentData, onClose }) => {
  ...
  useEffect(() => {
    ...
    // Create a reference to track if this is the initial mount
    const isInitialMount = useRef(true);

    // Only initialize form data on first mount or when section changes
    if (
